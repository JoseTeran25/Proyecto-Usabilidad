...
function Juegos() {
  ...
  return (
    <div className="flex flex-col items-center justify-center p-4 z-20 relative h-screen" role="navigation" aria-labelledby="juegos-heading">
      <h1 id="juegos-heading" className="text-4xl text-center font-bold pb-10" tabIndex="0" role={"document"}>Selecciona tu tema</h1>
      ...
      <div className="flex items-center justify-center w-full gap-[100px] relative" aria-live="polite">
        ...
        <div className="flex flex-col items-center z-10">
          <img
            ...
            role={"document"}
          />
          <h2 tabIndex="0" role={"document"} className="text-title2 mt-4 text-center">{opciones[indice].nombre}</h2>
        </div>
